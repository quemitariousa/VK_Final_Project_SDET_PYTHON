...
class TestsRegisterUser(BaseCase):
    '''
    Шаги выполнения:
    1. Зарегистрировать пользователя с middlename
    Ожидаемый результат: middlename != NULL
    '''
    ...
    '''
    Шаги выполнения:
    1. Зарегистрировать пользователя без middlename
    Ожидаемый результат: middlename == NULL
    '''
    @allure.epic('UI tests')
    @allure.feature('Register user')
    ...
    '''
    Шаги выполнения:
    1. Зарегистрировать пользователя с длинным username
    Ожидаемый результат: Невозможно зарегистрировать данного пользователя
    '''
    ...
    '''
    Шаги выполнения:
    1. Зарегистрировать пользователя с username  из одного символа
    Ожидаемый результат: Невозможно зарегистрировать данного пользователя
    '''
    @allure.epic('UI tests')
    @allure.feature('Register user')
    ...
    '''
   Шаги выполнения:
   1. Зарегистрировать пользователя с username  из из двух символов
   Ожидаемый результат: Корректное предупреждение на верстке
   '''
    @allure.epic('UI tests')
    @allure.feature('Register user')
    ...
    '''
   Шаги выполнения:
   1. Зарегистрировать пользователя с name при лимите
   Ожидаемый результат: Корректное предупреждение на верстке
   '''
    ...
    '''
       Шаги выполнения:
       1. Зарегистрировать пользователя с пустым name
       Ожидаемый результат: Корректное предупреждение на верстке
       '''
    @allure.epic('UI tests')
    @allure.feature('Register user')
   ...
   '''
    ...
    '''
   Шаги выполнения:
   1. Зарегистрировать пользователя с некорректным surname
   Ожидаемый результат: Корректное предупреждение на верстке
   '''
    @allure.epic('UI tests')
    @allure.feature('Register user')
    ...
    '''
   Шаги выполнения:
   1. Зарегистрировать пользователя с некорректным email
   Ожидаемый результат: Корректное предупреждение на верстке
   '''
    @allure.epic('UI tests')
    @allure.feature('Register user')
    ...
    '''
   Шаги выполнения:
   1. Зарегистрировать пользователя с некорректным pw
   Ожидаемый результат: Корректное предупреждение на верстке
   '''
    @allure.epic('UI tests')
    @allure.feature('Register user')
    ...
    '''
   Шаги выполнения:
   1. Зарегистрировать пользователя без обязательного флага подтверждения
   Ожидаемый результат: Корректное предупреждение на верстке
   '''
    @allure.epic('UI tests')
    @allure.feature('Register user')
    ...
    '''
   Шаги выполнения:
   1. Зарегистрировать пользователя, вводя разные пароли
   Ожидаемый результат: Корректное предупреждение на верстке
   '''
    @allure.epic('UI tests')
    @allure.feature('Register user')
    ...
    '''
   Шаги выполнения:
   1. Пройти по регистрации, пропуская обязательные поля
   Ожидаемый результат: Корректное предупреждение на верстке
   '''
    @allure.epic('UI tests')
    @allure.feature('Register user')
...
class TestsAuth(BaseCase):
    '''
      Шаги выполнения:
      1. Произвести корректный логин
      Ожидаемый результат: Логин успешен
      '''
    @allure.epic('UI tests')
    ...
    '''
  Шаги выполнения:
  1. Произвести некорректный логин
  Ожидаемый результат: Логин неуспешен
  '''
    @allure.epic('UI tests')
    @allure.feature('Authorization')
    ...
    '''
  Шаги выполнения:
  1. Пройти по всем сущностям навбара
  Ожидаемый результат: Ссылки соответствуют действительности
  '''
class TestsMainPage(BaseCase):
    ...
    '''
      Шаги выполнения:
      1. Пройти по всем основным кнопкам
      Ожидаемый результат: Ссылки соответствуют действительности
      '''
    @allure.epic('UI tests')
    @allure.feature('Main page')
  ...
  Шаги выполнения:
  1. Произвести логаут
  Ожидаемый результат: Логаут успешен
  '''
    @allure.epic('UI tests')
    @allure.feature('Main page')
    ...
    Ожидаемый результат: Переходим на главную страницу
    '''
    @allure.epic('UI tests')
    @allure.feature('Main page')
    ...
    '''
    Шаги выполнения:
    1. Нажать на кнопку python
    Ожидаемый результат: Отображается список навбара
    '''
    @allure.epic('UI tests')
    @allure.feature('Main page')
